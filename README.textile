...
[lift-basic]https://github.com/lift/lift_22_sbt/tree/master/lift_basic]
...
Obviously, a <pre><code><li></code></pre> tag inside a <pre><code><span></code></pre> is not proper HTML, but it's surprising that the binding fails silently in this way.